...
def main():
   ...
   data_transform = T.Compose(
      [T.RandomCrop(480), T.ToTensor(), T.Normalize(mean=mean, std=std)]
   )
...
# /home/cwk/projects/unet_test/DRIVE/test/mask/03_test_mask.gif

#'/home/cwk/projects/unet_test/data/DRIVE/test/mask/03_test_mask.gif'
